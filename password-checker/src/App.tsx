    ...
    <>
      <div className="w-full h-screen bg-slate-200 flex flex-col snap-none">
        ...
        <div className="w-full justify-center items-center flex flex-col">
          <label htmlFor="theme" className="inline-flex items-center space-x-4 cursor-pointer dark:text-gray-100 mt-2">
          ...
          <label htmlFor="langue" className="inline-flex items-center space-x-4 cursor-pointer dark:text-gray-100 mt-2">
